...
class SongPlayer : NSObject{
    ...
    func getStreamUrl(_ yt_id: String) {
        ...
        if let urlString = UserDefaults.standard.object(forKey: yt_id) as? String {
            ...
            let range = <#T##String.CharacterView corresponding to your index##String.CharacterView#>.index(expireRange!.lowerBound, offsetBy: 7)...<#T##String.CharacterView corresponding to your index##String.CharacterView#>.index(expireRange!.lowerBound, offsetBy: 16)
    ...
    func updateMediaPlayer() {
        ...
        let songInfo: [String: AnyObject] = [
            MPMediaItemPropertyTitle: playlistSong.title as AnyObject,
            MPMediaItemPropertyArtist: playlistSong.artist as AnyObject,
            MPMediaItemPropertyArtwork: albumArt,
            MPMediaItemPropertyPlaybackDuration: playlistSong.duration as AnyObject,
            MPNowPlayingInfoPropertyElapsedPlaybackTime: self.timePlayed as AnyObject
        ]
